...
function createCanvas(){
  ...
  let spawnPreyButton = document.createElement("button");
  spawnPreyButton.type = "button";
  spawnPreyButton.innerHTML = "Spawn Prey";
  spawnPreyButton.style.margin = "5px";
  spawnPreyButton.style.width = "100px";
  spawnPreyButton.style.height = "30px";
  spawnPreyButton.style.borderStyle = "solid";
  spawnPreyButton.style.borderColor = "black";
  spawnPreyButton.style.borderWidth = "3px";
  spawnPreyButton.style.fontFamily = "Arial";
  spawnPreyButton.style.fontWeight = "bold";
  spawnPreyButton.style.backgroundColor = "#c28f04";
  spawnPreyButton.style.cursor = "pointer";
  document.getElementById("buttonArea").append(spawnPreyButton);
  spawnPreyButton.addEventListener("mousedown", (event) => spawnButton(event, "prey"));
  spawnPreyButton.addEventListener("mouseup", (event) => spawnButton(event, "prey"));

  let spawnPredatorButton = document.createElement("button");
  spawnPredatorButton.type = "button";
  spawnPredatorButton.innerHTML = "Spawn Predator";
  spawnPredatorButton.style.margin = "5px";
  spawnPredatorButton.style.width = "120px";
  spawnPredatorButton.style.height = "30px";
  spawnPredatorButton.style.borderStyle = "solid";
  spawnPredatorButton.style.borderColor = "black";
  spawnPredatorButton.style.borderWidth = "3px";
  spawnPredatorButton.style.fontFamily = "Arial";
  spawnPredatorButton.style.fontWeight = "bold";
  spawnPredatorButton.style.backgroundColor = "#eb3434";
  spawnPredatorButton.style.cursor = "pointer";
  document.getElementById("buttonArea").append(spawnPredatorButton);
  spawnPredatorButton.addEventListener("mousedown", (event) => spawnButton(event, "predator"));
  spawnPredatorButton.addEventListener("mouseup", (event) => spawnButton(event, "predator"));
...
function spawnButton(e, unitType){
  let oldColor = e.target.style.backgroundColor;
  if (e.type == "mousedown"){
    e.target.style.backgroundColor = "green";
    if(unitType == "prey") spawnSingleUnit(unitType);
    if(unitType == "predator") spawnSingleUnit(unitType);
    log.newMsg(unitType + " was spawned");
    setTimeout(() => {e.target.style.backgroundColor = oldColor}, 100);
  };
};
...
let allUnits = createUnits(50, 50, 5);

function spawnSingleUnit(unitType){
  if(unitType == "prey") allUnits.push(new Unit(randomNumberBetween(5, canvas.width - 5), randomNumberBetween(5, canvas.height - 5), false));
  if(unitType == "predator") allUnits.push(new PredatorUnit(randomNumberBetween(5, canvas.width - 5), randomNumberBetween(5, canvas.height - 5), false));
  if(unitType == "food") allUnits.push(new FoodUnit(randomNumberBetween(5, canvas.width - 5), randomNumberBetween(5, canvas.height - 5)))
}
